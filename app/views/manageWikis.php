                                        ...
                                        <?php foreach ($wikisDATA as $wiki) { ?>
                                            <tr
                                                ...
                                                <td class="px-4 py-3 text-sm">
                                                    ...
                                                    <a href="index.php?action=hideWiki&id=<?= $wiki->getIdWiki() ?>"><button
                                                            class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100">
                                                            Hide Wiki </button></a>
                                                    <?php }else{?>
                                                        <a href="index.php?action=hideToShowWiki&id=<?= $wiki->getIdWiki() ?>"><button
                                                            class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-red-700 dark:text-red-100">
                                                            Show Wiki </button></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
